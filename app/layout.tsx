...
function GlobalBackgroundPro() {
  ...
  return (
    <div aria-hidden="true" className="fixed inset-0 -z-50 pointer-events-none">
      ...
      {/* Conic glow */}
      <div
        className="absolute -top-40 left-1/2 h-[120vh] w-[120vw] -translate-x-1/2 opacity-[.16] blur-3xl bg-[conic-gradient(from_180deg_at_50%_50%,#0ea5e9,#6366f1,#f59e0b,#0ea5e9)]"
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(115deg, transparent 0%, rgba(56,189,248,.12) 30%, transparent 60%)," +
            "linear-gradient(250deg, transparent 10%, rgba(168,85,247,.10) 45%, transparent 70%)",
          maskImage:
            "radial-gradient(60% 40% at 30% 30%, black 40%, transparent 70%)," +
            "radial-gradient(60% 40% at 70% 10%, black 40%, transparent 70%)",
          WebkitMaskImage:
            "radial-gradient(60% 40% at 30% 30%, black 40%, transparent 70%)," +
            "radial-gradient(60% 40% at 70% 10%, black 40%, transparent 70%)",
        }}
